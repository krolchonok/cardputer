...
class AppIrMenu::CategorySelectorMenu : public SmoothSelectorMenu {
public:
    struct OptionInfo_t {
        int appId = -1;
        std::string name;
...
void AppIrMenu::resolve_app_ids()
{
    _remote_app_id       = -1;
